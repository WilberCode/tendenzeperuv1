<div class="foundress bg-primary-500 py-20" id="foundress" >
    <div class="container">
        <div class=" grid md:grid-cols-2 gap-6  md:gap-16 lg:gap-24 ">
            <div class="  flex justify-end items-center" >
                <div  class="text-right pr-6 sm:pr-8 " >
                ...
                <img class="foundress-avatar  rounded-full " src="<?php echo get_theme_mod("martina_image"); ?>" alt="Martina" title="Martina">
            </div>
            <div class="flex justify-start items-center" >
                <img class="foundress-avatar  rounded-full " src="<?php echo get_theme_mod("karina_image"); ?>" alt="Karina" title="Karina">
